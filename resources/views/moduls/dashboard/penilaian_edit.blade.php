...
<section class="flex w-full">
    @include('moduls.dashboard.layouts.sidebar', ['active' => 'Penilaian Domba', 'data' => 0])
                    ...
                    <form action="{{ route('penilaian.update', $penilaian->id) }}" method="post">
                        ...
                        <div class="flex gap-1">
                            <div class="mb-1 pt-0 w-full">
                                ...
                                <input name="kode_alternatif" type="text" id="kode_alternatif" value="{{ $penilaian->kode_alternatif }}" placeholder="Kode Alternatif" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                            </div>
                            <div class="mb-1 pt-0 w-full">
                                <label for="jenis_pakan" class="text-blueGray-600 text-base font-medium">Jenis Pakan</label>
                                <input name="jenis_pakan" type="text" id="jenis_pakan" value="{{ $penilaian->jenis_pakan }}" placeholder="Jenis Pakan" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                            </div>
                        </div>
